...
<html lang="en">
  ...
  <body>
            ...
            @csrf
              <div class="row align-items-center">
                <div class="col-md mr-0 pr-md-0 mb-3 mb-md-0">
                  <input name="loginemail" class="form-control form-control-sm input-dark" type="text" placeholder="Email" autocomplete="on" value="{{ old('loginemail') }}" />
                </div>
                <div class="col-md mr-0 pr-md-0 mb-3 mb-md-0">
    ...
    <footer class="border-top text-center small text-muted py-3">
        <p class="m-0">Copyright &copy; {{ date('Y') }} <a href="dekkerweb.com" class="text-muted"><em>Dekkerweb.com</em></a>. All rights reserved.</p>
      </footer>
